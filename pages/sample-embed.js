      ...
      <nav className="bg-white py-2 md:py-4">
        <div className="container px-4 mx-auto md:flex md:items-center">
          ...
          <div className="hidden md:flex flex-col md:flex-row md:ml-auto mt-3 md:mt-0" id="navbar-collapse">
            ...
            <a href="#" className="p-2 lg:px-4 md:mx-2 text-gray-600 rounded-md hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">Pricing</a>
      ...
      <blockquote className="hipi-media" cite="https://www.hipi.co.in/">
        ...
        >
          <iframe
            ...
            src="https://www.hipi.co.in/embed/72cc05cb-fe62-493c-a40c-7de24390233e"
            loading="lazy"
            title="hipi"
            name="hipi"
            frameBorder="0"
