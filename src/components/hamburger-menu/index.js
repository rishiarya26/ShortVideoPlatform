  ...
  return (
    <>
      <div
        ...
        className="absolute top-0 left-4 burger mt-4 items-center flex justify-center p-4 z-20"
      >
        <Burger />
      </div>
      <div
        className={`absolute w-3/4 h-screen top-0 bg-white z-20 transition-all duration-500 motion-reduce:transition-none ${
          open ? "left-0" : "invisible -left-3/4"
        }`}
      >
        <div
          onClick={() => setOpen(false)}
          className="w-full  shadow-lg flex justify-between items-center bg-hipired p-4"
        >
          <img
            className="w-12 h-8"
            src={withBasePath("images/logo_hipi.png")}
            alt="hipi logo"
          />
          <Close />
        </div>
        <div className="flex flex-col p-4">
          <div className="flex flex-col">
            <div
              onClick={() => router && router?.push("/about")}
            ...
            <div
              onClick={() => router && router?.push("/newsroom")}
              className="flex items-center py-3"
            >
            ...
            <div
              onClick={() => router && router?.push("/ads")}
              className="flex items-center py-3"
            >
              <AdsIcon />
            ...
            >
              <List />
              <p className="text-base px-3 text-gray-900 ">
            ...
            <div
              onClick={() => router && router?.push("/terms-conditions.html")}
              className="flex items-center py-3"
            >
              <Terms />
