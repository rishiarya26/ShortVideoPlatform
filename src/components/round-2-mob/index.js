...
{/* <div className="flex justify-center items-center flex-col section_1 relative">
  <img src={withBasePath('images/goat/round-2/mob/land.jpg')} />
...
<div className="mt-4">
<img src={withBasePath('images/goat/round-2/mob/land1.jpg')}/>
    <img src={withBasePath('images/goat/round-2/mob/1.jpg')}/>
  </div>
<div className="">
    <img src={withBasePath('images/goat/round-2/mob/2.jpg')}/>
  </div>
<div className="flex w-full  section_2">
    <img className="h-full" src={withBasePath('images/goat/round-2/mob/3.jpg')}/>
</div>

<div className="section_3 flex items-center flex-col section_2">
   <img src={withBasePath('images/goat/round-2/mob/4.jpg')}/>
   
<img src={withBasePath('images/goat/round-2/mob/5.jpg')}/>

<img src={withBasePath('images/goat/round-2/mob/6.jpg')}/>
...
<img src={withBasePath('images/goat/round-2/mob/7.jpg')}/>
...
<>
  ...
  <img src={withBasePath('images/goat/round-2/mob/8.jpg')}/>
  ...
  <img src={withBasePath('images/goat/round-2/mob/9.jpg')}/>  
  <div className="relative">
  <img src={withBasePath('images/goat/round-2/mob/10.jpg')}/>
  ...
  <img src={withBasePath('images/goat/round-2/mob/11.jpg')}/>
  </div>
  </>
