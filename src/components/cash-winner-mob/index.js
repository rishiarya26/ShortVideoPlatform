...
function CashWinnerM({round}) {
  ...
  const getData = async()=>{
   try{
    ...
    const response = await getLeaderboardData({round : 4});
  ...
  return (
      ...
      <div className='w-full flex flex-col'>
        <div className="w-full border-b-2 border-gray-300 relative flex justify-center py-4">
            <p className="font-extrabold text-lg ">Round 3 Weekly Cash Prize Winners</p>
        </div>
      ...
      {data?.week6?.all?.length > 0 && data?.week6?.all?.[0] &&
        ...
        {/* {data?.week5?.all?.length > 0 && data?.week5?.all?.[0] && <div className="w-full border-b-2 border-gray-300 relative flex py-2 px-4">
            <p className="font-bold">{`Week 5 (${dates?.week5 || ''})`}</p>
        </div>
        }
      {data?.week5?.all?.length > 0 && data?.week5?.all?.[0] &&
        ...
        {data?.week4?.all?.length > 0 && data?.week4?.all?.[0] && <div className="w-full border-b-2 border-gray-300 relative flex py-2 px-4">
            <p className="font-bold">{`Week 4 (${dates?.week4 || ''})`}</p>
        </div>
        }
        {/* normal count */}
      {data?.week4?.all?.length > 0 && data?.week4?.all?.[0] &&
        ...
        {data?.week3?.all?.length > 0 && data?.week3?.all?.[0] && <div className="w-full border-b-2 border-gray-300 relative flex py-2 px-4">
            <p className="font-bold">{`Week 3 (${dates?.week3 || ''})`}</p>
        </div>
        }
        {/* normal count */}
      {data?.week3?.all?.length > 0 && data?.week3?.all?.[0] &&
       ...
       {data?.week2?.all?.length > 0 && <div className="w-full border-b-2 border-gray-300 relative flex py-2 px-4">
            <p className="font-bold">{`Week 2 (${dates?.week2 || ''})`}</p>
        </div>}
        {/* normal count */}
      {data?.week2?.all?.length > 0 && data?.week2?.all?.[0] &&
        ...
        {data?.week2?.judges?.map((item, key)=>(
          ...
          {/* </div>
           ...
           {data?.week1?.all?.length > 0 && <div className="w-full border-b-2 border-gray-300 relative flex py-2 px-4">
