...
{/* <div className="flex justify-center items-center flex-col section_1 relative">
  <img src={withBasePath('images/goat/round-3/mob/land.jpg')} />
...
<img src={withBasePath('images/goat/round-3/mob/land_1.jpg')}/>
    <img src={withBasePath('images/goat/round-3/mob/1.jpg')}/>
  </div>
<div className="">
    <img src={withBasePath('images/goat/round-3/mob/2.jpg')}/>
  </div>
<div className="flex w-full  section_2">
    <img className="h-full" src={withBasePath('images/goat/round-3/mob/3.jpg')}/>
</div>

<div className="section_3 flex items-center flex-col section_2">
   <img src={withBasePath('images/goat/round-3/mob/4.jpg')}/>
   
<img src={withBasePath('images/goat/round-3/mob/5.jpg')}/>

<img src={withBasePath('images/goat/round-3/mob/6.jpg')}/>
...
<img src={withBasePath('images/goat/round-3/mob/7.jpg')}/>
...
<>
  ...
  <img src={withBasePath('images/goat/round-3/mob/8.jpg')}/>
