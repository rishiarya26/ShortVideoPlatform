...
<img src={withBasePath('images/goat/round-3/mob/land_2.jpg')}/>
    <img src={withBasePath('images/goat/round-3/mob/1_1.jpg')}/>
  </div>
<div className="">
    <img src={withBasePath('images/goat/round-3/mob/2_1.jpg')}/>
  </div>
<div className="flex w-full  section_2">
    <img className="h-full" src={withBasePath('images/goat/round-3/mob/3_1.jpg')}/>
</div>

<div className="section_3 flex items-center flex-col section_2">
   <img src={withBasePath('images/goat/round-3/mob/4_1.jpg')}/>
   
<img src={withBasePath('images/goat/round-3/mob/5_1.jpg')}/>

<img src={withBasePath('images/goat/round-3/mob/6_1.jpg')}/>
...
<img src={withBasePath('images/goat/round-3/mob/7_1.jpg')}/>
...
<>
  ...
  <img src={withBasePath('images/goat/round-3/mob/8_1.jpg')}/>
