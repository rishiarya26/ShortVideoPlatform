   ...
   const handlePlay = entry => {
      if (clicked) {
         if (entry?.isIntersecting) {
            setActive(true);
            //console.log("IS_INTERSECTING", rootRef?.current, `fdfdfdfd`, rootRef?.current?.children[0]?.children?.[1]?.children?.[1]?.children?.[0])
      ...
      <div ref={rootRef} className="feed_card  border-b border-gray-300 pb-6 mb-6">
         <div ref={showVideoDetail ? null : ref} className="flex justify-between">
            <div className="avatar">
               ...
               className="flex items-center w-14 h-14 overflow-hidden cursor-pointer rounded-full"
               >
               <Img
            ...
            <div className="video_section flex flex-col  w-full ml-4">
               ...
               <div className="desk-feed rounded-lg overflow-hidden relative cursor-pointer">
                  ...
                  {muted ? (
                     ...
                     className="cursor-pointer absolute bottom-8 opacity-0 right-4"
                     >
                     <Mute />
                     </div>
                  ) : (
