...
const DeskMenu = ({ handleUpClick, handleDownClick, width = "w-full" }) => {
  ...
  return (
    <div
      className={`${width} flex fixed max-h-100v menu_bar overflow-y-scroll bg-white flex-col p-4 pt-24 z-1 relative`}
    >
      ...
      <div className="flex text-xs text-gray-400 pt-4 pr-8 flex-wrap static_links sm-menu">
        <div
          className="mr-2 cursor-pointer mb-2 hover:border-b"
        ...
        <div
          className="mr-2 cursor-pointer mb-2 hover:border-b"
          onClick={() => router && router?.push("/community-guidelines.html")}
        >
