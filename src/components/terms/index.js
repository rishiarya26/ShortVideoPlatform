  ...
  <div className='hidden md:flex'><Header/></div>
      ...
      <div className="tray-container">
		...
		<div className='mt-12  md:mt-24'>
			...
			<p>The Posts uploaded by You can also be discovered under the ‘Search’ tab on Hipi along with other Posts uploaded by other Users. For sake of clarity, ZEEL does not or make available any audio and/or audio-visual contents that belongs to any third-party neither ZEEL intends to make such third party publishers contents available on Hipi. Any such contents are uploaded and made available by the User at their own risk.</p>
