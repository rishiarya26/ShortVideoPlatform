    ...
    <div className="w-full h-full ">
      ...
      <div  className=" flex top-4 w-full items-center flex-col">
        ...
        {/* <div className="w-full flex justify-center"> */}
              {/* <div className="p-2 px-4 text-white mx-2 text-sm bg-gray-800 bg-opacity-70 rounded-full">
                        <p className="font-semibold">ROUND ONE</p>
              </div>
              <div className="p-2 px-4 text-white mx-2 text-sm bg-gray-800 bg-opacity-70 rounded-full">
                        <p className="font-semibold">ROUND TWO</p>
              </div>
              <div className="p-2 px-4 text-white mx-2 text-sm bg-gray-800 bg-opacity-70 rounded-full">
      ...
      <div ><h2 className=' py-5 w-full text-center my-2 font-bold text-lg'> Round 2 Winner</h2>
      <div className='pb-5'>
...
It’s still not late, you still have the chance to become the Greatest Of All Time!</p>
      ...
      {/* <div className="w-full absolute bottom-0 static_footer bg-black flex py-3 justify-between flex-col px-10 text-gray-300 z-20">
