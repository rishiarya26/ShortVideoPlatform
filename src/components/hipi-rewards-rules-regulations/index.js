...
function RewardsRules() {
  ...
  return (
	...
	<div className='mt-12 md:mt-24'>
			...
			<p className='flex'> <span className='px-2'>(i)</span>For any queries/complaints or clarifications in relation to the redemption of the on the Application, the Participant is required to contact ZEEL at <span> <a target="_blank" className='text-blue-600 font-medium cursor-pointer' href='mailto:contact@hipi.co.in' rel="noreferrer">contact@hipi.co.in</a></span></p>
			...
			<p className='flex'> <span className='px-2'>(u)</span>In case of any queries, please write to <span> <a target="_blank" className='text-blue-600 font-medium cursor-pointer' href='mailto:contact@hipi.co.in' rel="noreferrer">contact@hipi.co.in</a></span> setting out your concerns/issues related to the Contest. All endeavours shall be made to reply to the queries within reasonable time on a best effort basis. However, the absence of a reply shall not be deemed to mean acceptance by ZEEL of any claims made in the query.</p>
