...
function RewardsRules() {
  ...
  return (
	...
	<div className='mt-12 md:mt-24'>
			...
			<p className='flex'> <span className='px-2'>(vii)</span>"Participant(s)" means any person(s) who (i) has downloaded the latest version of Application on his/her Device, (ii) plays the Contest on the Application (iii) is present in India except resident(s) of  Andhra Pradesh and Telangana and (iv) is of sound mind and health and (v) has agreed to enter and participate in the Contest in accordance with the Rules & Regulations as defined in this document.</p>
			...
			<p className='flex'> <span className='px-2'>(c)</span>The Contest may work only in the territory of India and shall not be accessible from other territory(ies) across the world. Notwithstanding anything mentioned in this Rules and Regulations, resident(s) of Andhra Pradesh and Telangana are not eligible to participate in the Contest. The Gratification through the Contest shall be applicable only for Participant(s) from territories who are explicitly allowed and who are eligible and playing in India on the Application. </p>
			...
			<p className='flex pl-2'> <span className='px-2'>IX.</span>ix.	If ZEEL has reasonable grounds to suspect that a resident of Andhra Pradesh and Telangana has fraudulently participated in this Contest. </p>
