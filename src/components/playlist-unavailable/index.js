...
function PlaylistUnavailable({retry}) {

  return (
    <>
     <div className="md:hidden bg-gray-900 h-screen w-screen flex justify-center items-center text-white flex-col">
        <h1 className="text-xl font-semibold text-center px-4">The Playlist you are seeking is unavailable.</h1>
     ...
     <h1 className="text-lg font-semibold">The Playlist you are seeking</h1>
