...
<h1 className='text-3xl font-bold purple_font mb-2 px-4 text-center pb-2'> December Challenge 1 is now <span className='animate-pulse'>Live</span></h1>
    <p className='px-8 md:w-1/2 pb-6 md:pb-6 text-center text-gray-600 font-light'>
    <span onClick={()=>challenge1Ref.current.scrollIntoView({behavior: 'smooth'})  } className='hover:underline cursor-pointer'>Make a GRWM wedding look video</span>
</p>
...
{type === 'stunner' && <div className="stunner_swiper relative testimonials_swiper carousel">
    ...
    Participate in both challenges of the month to win a cash prize of INR 1,00,000 and much more. Check out Dec challenge 1 details <span onClick={()=>challenge1Ref.current.scrollIntoView({behavior: 'smooth'})  } className='font-bold text-blue-600 cursor-pointer'>HERE</span>
    </p> 
    {/* <p className='px-8 md:px-16 md:w-1/2 pb-2 text-center text-gray-600 font-light'> 
