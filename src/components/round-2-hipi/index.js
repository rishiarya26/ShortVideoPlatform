...
{/* <div className="flex justify-center items-center flex-col section_1 relative">
  <img alt="" src={withBasePath('images/goat/round-2/mobile/land.jpg')} />
...
<div className="mt-4">
<img alt="" src={withBasePath('images/goat/round-2/mobile/land1.jpg')}/>
<div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/1_rel.jpg')}/>
    <div className="absolute top-4 left-4 flex flex-col">
    <img alt="" className="w-3/4" src={withBasePath('images/goat/round-2/hipimobile/1_1.jpg')}/>
    <Link href='video/091556b4-cb69-4898-96b6-a03fdb4ae4a3'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    <Link href='video/b02ab4af-2546-4e11-b8f0-3565df2c11e5'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 2</a></Link>
    <Link href='video/d237a797-33f5-4333-b322-8c6f6d1ef9fb'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 3</a></Link>
    </div>
    <div className="absolute z-20 -bottom-8 right-4 w-3/4 flex flex-col items-end">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/1_2.jpg')}/>
    <Link href='video/f740f137-dd00-4ab7-a405-0c810363c361'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    <Link href='video/cafe7000-61cd-4620-9c9a-18366187985d'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 2</a></Link>
    <Link href='video/24826cc5-9f57-424d-8d54-c7c35f7e8996'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 3</a></Link>
    </div>

    </div>
    <div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/2_rel.jpg')}/>
    <div className="absolute bottom-6 left-4 flex flex-col itmes-start">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/3_1.png')}/>
    <Link href='video/8558148d-d3ea-4a23-a7fe-16bcb1954657'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    {/* <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 2</a>
    <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 3</a> */}
    </div>
    </div>

    <div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/3_rel.jpg')}/>
    <div className="absolute top-1/3 pt-8 right-4 flex flex-col items-end">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/3_2.jpg')}/>
    <Link href='video/fbd67e4b-7b8c-42d9-a78b-0962b25c75e7'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    <Link href='video/402a856f-743e-41de-b945-b5803347d4ea'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 2</a></Link>
    {/* <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 3</a> */}
    </div>
    </div>

    <div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/4_rel.jpg')}/>
    <div className="absolute top-4 left-4 flex flex-col items-start">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/4_1.jpg')}/>
    <Link href='video/006c7e9f-ad9a-4185-94eb-0f29292e685c'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    <Link href='video/1047357d-24e9-4b95-8c11-c4e82ee1d5e1'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 2</a></Link>
    <Link href='video/090b67bd-52b0-4796-9d06-56fe933c0555'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 3</a></Link>
    </div>
    </div>

    <div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/5_rel.jpg')}/>
    <div className="absolute top-4 right-8 flex flex-col items-end">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/5_1.jpg')}/>
    <Link href='video/612c3d0c-12fd-4b94-ae8d-b66f857e4d40'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    <Link href='video/7c819e2b-71e2-4253-8b65-59b5c8de5602'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 2</a></Link>
    {/* <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 3</a> */}
    </div>

    <div className="absolute -bottom-8 left-4 flex flex-col items-start">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/5_2.png')}/>
    <Link href='video/f2565254-97a1-40a2-a86f-1cf026023475'><a  target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    {/* <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 2</a>
    <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 3</a> */}
    </div>
    </div>
...
<img alt="" src={withBasePath('images/goat/round-2/mobile/6.jpg')}/>
   {/* <button className="flex px-12 py-3 my-6 bg-hipired rounded-full text-white font-semibold">Apply Now</button> */}
</div>

<div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/7_rel.jpg')}/>
    <div className="absolute top-4 right-4 flex flex-col items-end">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/7_1.jpg')}/>
    <Link href='video/7c60f7ff-8af8-436c-8ab6-6a2ce8a2d0eb'><a target="_blank"  className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    <Link href='video/80b68778-eb0e-4604-87c1-e0a9a8275bef'><a target="_blank"  className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 2</a></Link>
    {/* <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 3</a> */}
    </div>
</div>
...
<div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/8_rel.jpg')}/>
    <div className="absolute top-4 left-4 flex flex-col items-start">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/8_1.jpg')}/>
    <Link href='video/3b7c7067-1f82-46bd-bcca-7e7b4cc10060'><a target="_blank"  className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    <Link href='video/3a4003b9-a2c5-4a8f-8543-e6c993ec0b1c'><a target="_blank"  className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 2</a></Link>
    {/* <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 3</a> */}
    </div>
</div>

<div  className="relative">
    <img alt="" src={withBasePath('images/goat/round-2/hipimobile/9_rel.jpg')}/>
    <div className="absolute top-2 right-4 flex flex-col items-end">
    <img alt="" className="" src={withBasePath('images/goat/round-2/hipimobile/9_1.jpg')}/>
    <Link href='video/2b1c4a3c-7c92-4c06-a91d-c18cecaa6fcd'><a target="_blank"  className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm" >Reference Video 1</a></Link>
    {/* <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 2</a>
    <a href="" target="_blank" className="font-semibold mt-0.5 underline underline-offset-8 text-blue-600 text-sm">Reference Video 3</a> */}
    </div>
</div>
<>
  ...
  <img alt="" src={withBasePath('images/goat/round-2/mobile/Round2DetailsMobile.png')}/>
  </div>
  ...
  <img alt="" src={withBasePath('images/goat/round-2/mobile/11.jpg')}/>
  </div>
  </>
...
{items?.map((data, id)=>(
  ...
  {data.show && <div id={id} className="pt-2 pl-6 text-purple-400 transition duration-500 ease-in-out"> {data.ans}</div>}
      ...
      {/* <div className="w-full p-4 flex bg-white sticky bottom-0 z-20 shadow-inner items-center justify-between">
        ...
        <div>
            <a className="border-2 border-gray-400 text-gray-600 px-3 py-1 mx-4 rounded-md text-sm" target="_blank" href="https://hipi.onelink.me/tMco/34447a88"  >Install</a>
        </div>
      </div> */}
