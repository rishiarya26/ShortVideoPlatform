...
<div className="flex flex-col w-screen h-screen">
   ...
   <div className="flex w-full h-screen bg-white justify-center relative overflow-hidden">
      ...
      <div className="w-5/6 p-8 flex flex-col overflow-scroll">
         ...
         <div className="absolute right-4 top-4">
            ...
            <div className="flex items-center pb-2">
               ...
               <div className="flex flex-col h-32 justify-between">
                  ...
                  <button className="font-semibold text-sm border border-hipired rounded-sm py-1 px-24 mr-1 h-10 bg-hipired text-white">Follow</button>
               </div>
            </div>
            ...
            <div className="Bio">
               <p className="py-4 pr-12 text-gray-00 text-sm text-center h-full flex items-center">
                                 Bio goes here
               </p>
            </div>
            </div>
            ...
            <div className="Video_gallery flex flex-col">
               <div className="flex tabs">
                  <div className="px-24 font-semibold text-md py-2 border-b-2 border-black">
                     Videos
                  </div>
                  <div className="px-24 font-semibold text-md py-2">
                     Liked
                  </div>
               </div>
               <div className="video-tiles flex flex-wrap -ml-4">
                  <div className="w-44 h-64 m-4 rounded-md overflow-hidden">
                  <img src="https://akamaividz2.zee5.com/image/upload/w_297,c_scale,f_auto,q_auto/v1643111692/hipi/videos/0b9adcb9-4269-4e56-add4-a71fd9e34f90/0b9adcb9-4269-4e56-add4-a71fd9e34f90_00.webp"/>
                  </div>
                  <div className="w-44 h-64 mx-2 my-4 rounded-md  overflow-hidden">
                     <img src="https://akamaividz2.zee5.com/image/upload/w_297,c_scale,f_auto,q_auto/v1643111692/hipi/videos/0b9adcb9-4269-4e56-add4-a71fd9e34f90/0b9adcb9-4269-4e56-add4-a71fd9e34f90_00.webp"/>
                  </div>
                  <div className="w-44 h-64 mx-2 my-4 rounded-md  overflow-hidden">
                     <img src="https://akamaividz2.zee5.com/image/upload/w_297,c_scale,f_auto,q_auto/v1643111692/hipi/videos/0b9adcb9-4269-4e56-add4-a71fd9e34f90/0b9adcb9-4269-4e56-add4-a71fd9e34f90_00.webp"/>
