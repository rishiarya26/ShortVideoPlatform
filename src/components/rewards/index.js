    ...
    <div className=' md:mt-24'>
        ...
        <div className="">
            <div className='flex  flex-col items-center w-full py-8 px-4 md:py-14 bg_pastel_reward text-center'>
                ...
                <div className='border border-gray-400 p-4 w-4/12 md:w-40 flex flex-col m-4'>
                <p className=' pl-2 font-medium text-sm reward_font'>Level</p>
                    <p className='mb-2 pl-2 font-bold text-3xl reward_font'>1</p>
                     <p className='pl-2 text-gray-500 text-sm font-medium'>On viewing 10 videos</p>
                </div>
                <div className='border border-gray-400 p-4 w-4/12 md:w-40 flex flex-col m-4 mx-8'>
                <p className=' pl-2 font-medium text-sm reward_font'>Level</p>
                    <p className='mb-2 pl-2 font-bold text-3xl reward_font'>2</p>
                     <p className='pl-2 text-gray-500 text-sm font-medium'>On viewing 20 videos</p>
                </div>
                <div className='border border-gray-400 p-4 w-4/12 md:w-40 flex flex-col m-4'>
                <p className=' pl-2 font-medium text-sm reward_font'>Level</p>
                    <p className='mb-2 pl-2 font-bold text-3xl reward_font'>3</p>
                     <p className=' pl-2 text-gray-500 text-sm font-medium'>On viewing 30 videos</p>
                </div>
                </div>
   
                <p className='text-left w-full md:w-4/12 font-sm'>           
