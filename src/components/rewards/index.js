    ...
    <div className=' md:mt-24'>
        <div className='flex w-full flex-col-reverse md:flex-row pb-4 md:pb-12'>
            <div className='w-full md:w-1/2 flex-col flex py-6 md:pl-40 md:p-8 px-8 justify-center '>
                <h1 className='text-3xl text-center md:text-left orange_font font-bold font-gray-700 pb-2 mt-4 mb-2'>Earn Rewards with Hipi</h1>
        ...
        <div className="">
            <div className='flex  flex-col items-center w-full py-8 px-4 md:py-14 bg_orange text-center'>
                <h3 className='mt-4 font-medium text-2xl pb-1 orange_font'>Earn rewards when you watch videos</h3>
                ...
                <p className='text-center w-full md:w-1/2'>Videos that are watched completely will be considered. Videos that are watched partially or skipped will not be considered. Only one view for a video will be considered even if you watch the same video multiple times.</p>
            </div>
            <div className='flex  flex-col items-center w-full py-8 px-4 md:py-14 bg_1 text-center'>
                <h3 className='mt-4 font-medium text-2xl pb-1 orange_font'>Earn rewards when you follow creators</h3>
                ...
                <p className='text-center w-full md:w-1/2'>Only one follow for a creator will be considered even if you follow and unfollow the creator multiple times.</p>
            </div>
            <div className='flex  flex-col items-center w-full py-8 px-4 md:py-14 bg_orange text-center'>
                <h3 className='mt-4 font-medium text-2xl pb-1 orange_font'>Earn rewards when you create video and share it with your friends</h3>
                ...
                <p className='text-center w-full md:w-1/2'>A new video is to be posted and shared. Videos posted or shared by you in the past will not be considered. </p>
                <p className='text-center w-full md:w-1/2'>Views by your friends on the video through the video link shared by you will be considered. Views on the video by other users on the app will not be considered.</p>
            </div>
            <div className='flex  flex-col items-center w-full py-8 px-4 md:py-14 relative text-center'>
                ...
                <h3 className='mt-4 font-medium orange_font text-lg pb-1'>Where to find the status of your levels and earn reward coins</h3>
                ...
                <h3 className='mt-4 font-medium orange_font text-lg pb-1'>Details & Conditions</h3>
                ...
                <h3 className='mt-4 font-medium orange_font text-lg pb-1'>Terms & Conditions</h3>
