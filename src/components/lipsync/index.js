...
<div className='w-full flex justify-center items-center flex-col-reverse md:flex-row  py-4 md:py-20 bg_lipsync_blue relative'>
        ...
        <div className='max_800 w-full  flex-col flex py-8 md:p-8 px-8 justify-center'>
            ...
            <div className='flex'><p className='mb-2 pl-4 text-gray-600 font-light'>You LOVE movies and enjoy acting, be it in front of the mirror or camera. Enacting your favourite movie moments or songs is your THING!</p></div>
