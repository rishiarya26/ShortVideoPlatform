...
<>
  ...
  <div onClick={()=>router.push('/goat-round-2')} className="w-1/3 cursor-pointer bg-hipired rounded-sm shadow-md px-4 py-2 text-white flex justify-center font-semibold">
  View Themes
  </div>
  </div>
  </div>
