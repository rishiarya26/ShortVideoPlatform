      ...
      <div className="w-full h-full">
        ...
        <div className='py-4 md:py-20 w-full flex flex-col items-start md:w-feed md:flex-row'>
          ...
          <div className='w-full md:w-1/3 flex  px-4 md:pl-0 pt-4 md:pt-0'>
            <div className='w-full md:w-2/3 flex relative rounded-md overflow-hidden'>
              <video
                className='w-full'
                src={withBasePath('videos/goat2/goat_intro.mp4')}
                ...
                muted={mute}
              />
              <div className='absolute cursor-pointer top-4 right-4' onClick={toggleMute}>
              {mute ? <Mute /> : <UnMute />}
              </div>
            </div>
          </div>
