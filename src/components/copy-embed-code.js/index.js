...
const CopyEmbedCode = ({ videoId = '', onEmbedCopy }) => {
  const embedCode = videoId && `<blockquote className="hipi-media" cite="https://preprod.hipi.co.in/"><div id="embed-hipi" style="position: relative; margin: 0 auto; height: 640px; width: 360px; overflow: hidden" > <iframe style="height: 100%; width: 100%" src="https://preprod.hipi.co.in/embed/${videoId}" loading="lazy" title="hipi" name="hipi" frameBorder="0" marginWidth="0" marginHeight="0" scrolling="no" /> </div> </blockquote>`;
