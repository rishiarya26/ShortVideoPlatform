...
const CopyEmbedCode = ({ videoId = '', onEmbedCopy }) => {
  const embedCode = videoId && `<blockquote className="hipi-media" cite="https://www.hipi.co.in/"><div id="embed-hipi" style="position: relative; margin: 0 auto; height: 870px; width: 360px; overflow: hidden" > <iframe style="height: 100%; width: 100%" src="https://www.hipi.co.in/embed/${videoId}" loading="lazy" title="hipi" name="hipi" frameBorder="0" marginWidth="0" marginHeight="0" scrolling="no" /> </div> </blockquote>`;
