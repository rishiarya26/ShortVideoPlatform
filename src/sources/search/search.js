...
import { transformSuccess, transformError } from '../transform/search/search';
...
async function fetchSearchResult({
  ...
  let response = {};
  try {
    const apiPath = `${getApiBasePath('hipi')}/v1/shorts/search?keyword=${keyword}&limit=${limit}&offset=${offset}`;
