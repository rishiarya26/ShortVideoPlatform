...
import { transformSuccess, transformError } from '../transform/search/music';
...
async function fetchSearchResult({
  ...
  let response = {};
  try {
    const apiPath = `${getApiBasePath('hipi')}/v1/shorts/search/result/music?keyword=${keyword}&limit=${limit}&offset=${offset}`;
