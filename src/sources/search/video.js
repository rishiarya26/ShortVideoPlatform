...
import { transformSuccess, transformError } from '../transform/search/videos';
...
async function fetchSearchResult({
  ...
  let response = {};
  try {
    const apiPath = `${getApiBasePath('hipi')}/v1/shorts/search/result/videos?keyword=${keyword}&limit=${limit}&offset=${offset}`;
