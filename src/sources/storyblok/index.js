...
import { transformError as transformErrorPage, transformSuccess as transformSuccessPage } from "../transform/storyblok/pages";
...
async function storyblokData({params, parentSlug, slug}) {
    ...
    let response = {};
    try {
        response = await storyblokApi.get(`cdn/stories/${parentSlug && slug ? parentSlug+"/"+slug : ""}`, params);
...
const [getStoryblokPage] = apiMiddleWare(storyblokPage, transformSuccessPage, transformErrorPage, {shouldCache : false});
